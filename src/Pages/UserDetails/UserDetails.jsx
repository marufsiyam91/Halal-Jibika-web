    ...
    <div className={style.jobcard_wrapper}>
      <div className={style.jobCard}>
        ...
        <div className={style.jobDetails}>
          ...
          <h3>Requirements</h3>
          <ul>
            <li>Bachelors degree in Computer Science or a related field...</li>
            <li>X+ years of experience in software development...</li>
            <li>
              Proficiency in [specific technologies or programming languages]...
            </li>
            <li>Strong problem-solving and analytical skills...</li>
          </ul>

          <h3>Qualifications</h3>
          <p>Bachelors degree in Computer Science or a related field...</p>
          ...
          <h3>How to Apply</h3>
          <p>
            If you are passionate about software development and want to be part
            of an innovative team...
          </p>

          <p>
            <strong>Application Deadline:</strong>{" "}
            {expireDate ?? "01, 02, 2024"}
          </p>

          <span onClick={() => handleApplyed(data)}>
